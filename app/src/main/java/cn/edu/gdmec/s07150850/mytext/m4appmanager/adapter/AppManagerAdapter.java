package cn.edu.gdmec.s07150850.mytext.m4appmanager.adapter;
...
import cn.edu.gdmec.s07150850.mytext.m4appmanager.utils.EngineUtils;
...
public class AppManagerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (position==0){
            ...
            TextView tv=getTextView();
            tv.setText("系统系统："+SystemAppInfos.size()+"个");
            return tv;
        }
        AppInfo appInfo;
        if (position<(UserAppInfos.size()+1)){
