...
import m4appmanager.utils.DensityUtil;
...
public class ProcessManagerAdapter extends BaseAdapter{
    ...
    @Override
    public int getCount() {
        if (mSystaskInfos.size()>0 & mSP.getBoolean("showSystmProcess",true)){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView!=null && convertView instanceof RelativeLayout){
            ...
            holder.mAppMemoryTV=(TextView) convertView.findViewById(R.id.tv_memory_processmanager);
