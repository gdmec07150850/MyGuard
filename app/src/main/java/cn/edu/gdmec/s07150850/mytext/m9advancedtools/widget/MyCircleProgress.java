...
import cn.edu.gdmec.s07150816.myguard.m9advancedtools.utils.DensityUtil;
//自定义控件，带进度的按钮
public class MyCircleProgress extends Button{
    ...
    private  void init(Context context,AttributeSet attrs){
        ...
        max=typedArray.getInteger(R.styleable.MyCircleprogrss_max,100);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //中间的进度百分比，先转化成float在进行除法运算，不然都为0
